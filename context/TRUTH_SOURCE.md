# Consolidated User Vision - Supreme Truth Source

## Authority Declaration

**SUPREME AUTHORITY**: This document OVERRIDES CLAUDE.md and all other system documents when conflicts arise.

**HIERARCHICAL SUPREMACY**: context/user-vision/TRUTH_SOURCE.md → CLAUDE.md → commands/ → system files
...
- Raw Source: 68 conversations in context/conversations/
...
### Revolutionary Architectural Principle: "Context Como Padre de Todo"
**SUPREME ARCHITECTURAL INSIGHT**: "Context como padre de todo" [20250729_1217 conversation]

This represents the user's crystallized understanding that all system knowledge IS context in different processing stages:
...
### Context Management & Token Economy Architecture
"La idea de tener esta estructura modular tiene mucho que ver con la carga cognitiva que puede soportar un agente o un LLM, tiene que ver con la economía de tokens, tiene que ver con la eficiencia de contexto" [Current conversation]

**FUNDAMENTAL PRINCIPLE**: "probablemente eso sea una de las cosas más importantes que debe aparecer en la verdad única del proyecto" [Current conversation]

**CORE PROBLEM IDENTIFIED**: "uno de los grandes problemas que he tenido en todos mis desarrollos es este, que es el problema de contexto, el que tenga archivos monolíticos que se vuelven imposibles de manejar" [Current conversation]

This manifests as:
- Modular architecture for cognitive load management
- Anti-monolithic file design preventing context overflow
- Context efficiency as architectural driver
- Token economy awareness in system design
- Referential linking over content duplication
...
**OPERATIONAL LIMIT**: ≤80 lines per file for cognitive load optimization
**TRIGGER CONDITION**: Auto-refactoring when files exceed threshold
**METHODOLOGY**: Modular decomposition preserving information density
