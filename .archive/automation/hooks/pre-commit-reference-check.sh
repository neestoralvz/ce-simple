...
# Template patterns that are expected to have similarity
TEMPLATE_PATTERNS=(
    "docs/commands/functional/.*/README.md"
    "commands/shared/.*/compact-.*.md"
    "scripts/results/.*/.*-summary-.*.md"
    "scripts/results/.*/.*-report-.*.md"
)

# Duplication thresholds by file type
TEMPLATE_SIMILARITY_THRESHOLD=0.50  # Allow 50% similarity for navigation templates
COMMUNICATION_PATTERN_THRESHOLD=0.30  # Allow 30% for communication patterns
REPORT_TEMPLATE_THRESHOLD=0.10  # Strict 10% for actual reports
...
"/Users/nalve/claude-context-engineering/scripts/automation/auto-update-handoffs-summary.sh" hook
