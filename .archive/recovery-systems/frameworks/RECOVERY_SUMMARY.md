...
- `performance-metrics-framework.md` - System performance measurement and monitoring → CONSOLIDATED into `/frameworks/performance-foundation-unified.md`
