...
**Authority:** context/TRUTH_SOURCE.md + /actions:recreate integration
...
**Authority:** context/templates/ + context/TRUTH_SOURCE.md alignment
...
**Authority chain:** context/TRUTH_SOURCE.md → drift detection → /actions:recreate delegation
...
**Si requieres authority validation:** → context/TRUTH_SOURCE.md:93-94
